    ...
    <Container>
      <div className="w-full max-w-4xl mx-auto overflow-hidden lg:mb-20 rounded-2xl ">
        <div
          ...
          {playVideo && (
            <iframe width="560" height="315" src="https://www.youtube.com/embed/pS943sPx8cI" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullscreen></iframe>
          )}
        </div>
      </div>
    </Container>
